# Generated by Django 4.1 on 2022-10-07 14:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auctions', '0026_alter_comment_date_alter_listing_winner'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='comment',
            name='date',
            field=models.DateTimeField(default=datetime.datetime(2022, 10, 7, 14, 8, 49, 708374)),
        ),
        migrations.AlterField(
            model_name='listing',
            name='winner',
